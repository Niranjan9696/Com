...
# Logo 
logo="    
${blue} _   _ ___ ____      _    _   _     _   _    _   _        ____    _    __  __
${blue} | \ | |_ _|  _ \    / \  | \ | |   | | / \  | \ | |      / ___|  / \  |  \/  |
${blue} |  \| || || |_) |  / _ \ |  \| |_  | |/ _ \ |  \| |_____| |     / _ \ | |\/| |
${blue} | |\  || ||  _ <  / ___ \| |\  | |_| / ___ \| |\  |_____| |___ / ___ \| |  | |
${blue} |_| \_|___|_| \_\/_/   \_\_| \_|\___/_/   \_\_| \_|      \____/_/   \_\_|  |_|
${green}                                               [Created By Niranjan Tech]
${red}                                                 Created For Educational Purposes Only
"
...
trap "echo -e '\n${success}Thanks for Using! My Tool -Niranjan; exit" 2
...
$red[Powered by] ${cyan} :{By NiranjanTech}
printf "${cyan}\niranjan${nc}@${cyan}tech ${red}$ ${nc}"
read about
